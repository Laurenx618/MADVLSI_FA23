...
C {madvlsi/tt_models.sym} 530 -30 0 0 {
name=TT_MODELS
only_toplevel=false
value=".option wnflag=1
.lib ~/skywater/skywater-pdk/libraries/sky130_fd_pr_ngspice/latest/models/sky130.lib.spice tt"
}
C {devices/code_shown.sym} 400 120 0 0 {name=s1 only_toplevel=false value=".dc Vin 0 1.8 0.001 Vref 0.7 1.5 0.2
.save v(Vout) v(Vin) v(Vref)"}

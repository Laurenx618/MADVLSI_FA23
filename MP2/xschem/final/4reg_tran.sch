...
C {devices/code_shown.sym} 730 150 0 0 {name=SPICE only_toplevel=false value=".tran 0.01n 1u
.save all"}
...
C {devices/lab_pin.sym} 630 90 0 1 {name=p5 sig_type=std_logic lab=V_Q}
C {devices/lab_pin.sym} 630 120 0 1 {name=p6 sig_type=std_logic lab=V_QB}
...
C {madvlsi/sf_models.sym} 720 -10 0 0 {
name=SF_MODELS
only_toplevel=false
